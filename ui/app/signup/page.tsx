    ...
    <div className="min-h-screen flex items-center justify-center bg-background relative overflow-hidden px-4 md:px-0">
      ...
      >
        <div className="flex flex-col items-center text-center mb-10">
          <div className="relative flex h-16 w-16 items-center justify-center rounded-[1.5rem] bg-primary/20 shadow-inner mb-6">
            <UserPlus className="h-8 w-8 text-primary ml-1" />
          </div>
          <h1 className="text-3xl sm:text-4xl font-heading font-black tracking-tight mb-2">Create an account</h1>
          <p className="text-muted-foreground text-base">Enter your details below to get started.</p>
        </div>
        ...
        <form className="space-y-6">
          <div className="space-y-5">
            ...
            <div className="space-y-2">
              <Label htmlFor="confirmPassword" className="font-bold ml-1">Confirm Password</Label>
              <Input 
                id="confirmPassword" 
                type="password" 
                required 
          ...
          <Button type="submit" className="w-full h-14 text-lg font-black rounded-full transition-transform hover:scale-[1.03] shadow-lg shadow-primary/20">
            Sign up
          </Button>
